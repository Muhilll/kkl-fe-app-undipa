...
const CompletedView: Component<CompletedViewProps> = (props) => {
  const getOptionLabel = (ans: MahasiswaQuestionnaireAnswer, score: number) => {
    switch (score) {
      case 1:
        return ans.options_one;
      case 2:
        return ans.options_two;
      case 3:
        return ans.options_three;
      case 4:
        return ans.options_four;
      case 5:
        return ans.options_five;
      default:
        return `Pilihan ${score}`;
    }
  };
  ...
  const handlePrintPdf = () => {
    ...
    printTableToPdf({
      ...
      subtitle: `Kuesioner: ${props.questionnaireName} | NIM: ${m?.nim || "-"}`,
      headers: ["No", "Butir Pertanyaan", "Jawaban yang Dipilih"],
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", "flex-direction": "column", gap: "4px" }}>
            ...
            <strong style={{ color: "var(--brand-800)", "font-size": "15px" }}>
              {props.submissions.length} Butir Pertanyaan
            </strong>
          </div>
          <div style={{ display: "flex", "flex-direction": "column", gap: "4px" }}>
            <span style={{ color: "var(--gray-500)", "font-size": "13px" }}>
        ...
        >
          <div>
            ...
            <p style={{ margin: 0, "font-size": "13px", color: "var(--gray-500)" }}>
              Rincian jawaban setiap butir pertanyaan yang telah Anda kirimkan.
            </p>
          </div>
